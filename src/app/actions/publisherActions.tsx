...
export const fetchPublishers = cache(async (forceRefresh: boolean = false): Promise<Publisher[]> => {
  const now = Date.now()
  if (!forceRefresh && cachedPublishers && (now - lastFetchTime < CACHE_DURATION)) {
