  ...
  return (
    <div className="p-4 sm:p-6">
      <div className="flex justify-between items-center mb-4 sm:mb-6">
        ...
        >
          <PlusIcon className="md:mr-2 mr-0 h-4 w-4 " />
          <span className="hidden md:block">Add Publisher</span>
        </Button>
      </div>
      <div
        className={`flex ${
          isFiltersExpanded ? "flex-col lg:flex-row" : "flex-col gap-1 sm:gap-1"
        } gap-2 sm:gap-4`}
      >
        <div
          className={`${
            isFiltersExpanded
              ? "w-full lg:w-[300px] mt-4 flex-shrink-0"
              : "w-full"
        ...
        >
          {loading ? (
            ...
            <DataTable
              ...
              onDataTableRefresh={onDataTableRefresh}
            />
          )}
        </div>
      </div>
